...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post managers_url, params: { manager: { cpf: @manager.cpf, name: @manager.name, telephone: @manager.telephone } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { cpf: @manager.cpf, name: @manager.name, telephone: @manager.telephone } }
